            ...
            <form id="delete-log-form" action="{{ route('log-viewer::logs.delete') }}" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">@lang('Eliminar archivo log')</h5>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-secondary mr-auto" data-dismiss="modal">@lang('Cancelar')</button>
                        <button type="submit" class="btn btn-sm btn-danger" data-loading-text="@lang('Loading')&hellip;">@lang('Eliminar')</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        $(function () {
            ...
            $("a[href='#delete-log-modal']").on('click', function(event) {
                ...
                var date    = $(this).data('log-date'),
                    message = "{{ __('Seguro que desea ELIMINAR este archivo: :date ?') }}";
